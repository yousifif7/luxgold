...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('panel/assets/updated-logo.jpeg') }}">

    <!-- Apple Icon -->
    <link rel="apple-touch-icon" href="{{ asset('panel/assets/updated-logo.jpeg') }}">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="index.html" class="logo">
                        ...
                        <span class="logo-light">
                            ...
                            <span class="logo-sm">
                                <img src="{{ asset('panel/assets/updated-logo.jpeg') }}" alt="small logo">
                            </span>
                        </span>
                        ...
                        <span class="logo-dark">
                            <span class="logo-lg">
                                <img src="{{ asset('panel/assets/updated-logo.jpeg') }}" alt="dark logo">
                            </span>
                        </span>
                ...
                @endif
                    ...
                    <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative" data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                            <img src="{{ asset('panel/assets/img/users/avatar-5.jpg') }}" width="32" class="rounded-2 d-flex" alt="user-image">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                            <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                                <img src="{{ asset('panel/assets/img/users/avatar-5.jpg') }}" class="rounded-circle" width="42" height="42" alt="Profile">
                                 <div class="ms-2">
    ...
    <span class="d-block fs-13">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-logo">
                <div>
                    <!-- Logo Normal -->
                    <a href="{{ route('parent-home') }}" class="logo logo-normal">
...
<script src="https://code.jquery.com/jquery-3.7.1.js" integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4=" crossorigin="anonymous"></script>
    ...
    <script src="{{ asset('admin/assets/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="04dbc81d7559b6c889b410c1-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"97f804d548a25cdb","version":"2025.8.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
...
<script src="{{ asset('admin/assets/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="b3e2be4978e0c4f64e5ccd88-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"97f808959cf33fb8","version":"2025.8.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
