...
<head>
    ...
    <!-- Choices CSS -->
    <link rel="stylesheet"
        href="{{ asset('provider/assets/plugins/choices.js/public/assets/styles/choices.min.css') }}">
...
<body>
                    ...
                    <div class="dropdown provider/-dropdown d-flex align-items-center justify-content-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                            <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                                ...
                                <div class="ms-2">
                                    <p class="fw-medium text-dark mb-0">{{ Auth::user()->first_name ?? 'Provider' }}
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('cleaner.hire-requests') }}">
                                        <i class="ti ti-mail"></i><span>Cleaning Requests</span>
                                    </a>
                                </li>
                                {{-- <li>
  ...
  ========================= -->
    ...
    <script src="{{ asset('provider/assets/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}"
