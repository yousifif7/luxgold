...
<body>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="index.html" class="logo">
                        ...
                        <span class="logo-light">
                            <span class="logo-lg">
                                <img src="{{ asset('assets/images/luxgold.jpg') }}" alt="logo">
                            </span>
                            <span class="logo-sm">
                                <img src="{{ asset('assets/images/luxgold.jpg') }}" alt="small logo">
                            </span>
                        </span>
                        ...
                        <span class="logo-dark">
                            <span class="logo-lg">
                                <img src="{{ asset('assets/images/luxgold.jpg') }}" alt="dark logo">
                            </span>
                        </span>
							...
							<div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
								...
								<div class="notification-body position-relative z-2 rounded-0" data-simplebar>
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-1">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="assets/img/users/user-01.jpg" class="avatar-md rounded-circle" alt="">
											</div>
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-2">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="assets/img/users/user-12.jpg" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
									...
									<div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-3">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="assets/img/provider/s/avatar-12.jpg" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
									...
									<div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
										<div class="d-flex">
											<div class="me-2 position-relative flex-shrink-0">
												<img src="assets/img/provider/s/avatar-08.jpg" class="avatar-md rounded-circle" alt="">
											</div>
											<div class="flex-grow-1">
            ...
            <div class="sidebar-logo">
                <div>
                    <!-- Logo Normal -->
                        ...
                        <img src="{{ asset('assets/images/luxgold.jpg') }}" height="40px" alt="Logo">
                    </a>
    ...
    <!-- jQuery -->
    <script src="{{ asset('provider/assets/js/jquery-3.7.1.min.js') }}" type="04dbc81d7559b6c889b410c1-text/javascript"></script>
