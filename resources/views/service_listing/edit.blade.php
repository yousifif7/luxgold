        ...
        <div class="service-listing-step-content-area">
            ...
            <div class="service-listing-step-content-panel service-listing-step-active-content" style="display:none" id="step1Content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="service-listing-form-group-container">
                            ...
                            <input type="text" class="service-listing-form-input-field" 
                                   id="profileNameDisplay" value="{{ old('profile_name', $serviceListing->name ?? ($serviceListing->user->name ?? auth()->user()->name)) }}" 
                                   placeholder="Cleaner name" disabled>
                            <input type="hidden" id="profileName" name="profile_name" value="{{ $serviceListing->name ?? ($serviceListing->user->name ?? auth()->user()->name) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="service-listing-form-group-container">
                    ...
                    <div class="col-md-6">
    {{-- Service Type removed for cleaning-only domain --}}
</div>
<div class="col-md-6">
    <div class="service-listing-form-group-container">
        <label class="service-listing-form-label-text">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateStep(step) {
        ...
        switch(step) {
            case 1:
                // Validate basic info
                // Profile name is not editable here; read from hidden field
                ...
                // Profile name comes from cleaner account; no client-side validation here
