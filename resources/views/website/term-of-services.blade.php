...
@section('title', 'Terms Of Services - luxGold')
@push("links")
<style>
...
@section('content')
  ...
  <section class="container tos-section">
    ...
    <p>Welcome to luxGold. Please read on to learn the rules and restrictions that govern your use of our website(s), products, services, and applications (the “Services”).</p>
    <p>These Terms of Use (the “Terms”) are a binding contract between you and Privy Consulting, Inc., doing business as luxGold (“luxGold,” “Company,” “we,” or “us”).</p>
    ...
    <p>If you have any questions, comments, or concerns about these Terms or the Services, please contact us at: <a href="mailto:info@luxgold.com">info@luxgold.com</a></p>

    <h4>Will these Terms ever change?</h4>
    <p>We are constantly improving luxGold, so these Terms may need to change as well. If we make material changes, we’ll notify you through the website, by email, or other reasonable methods.</p>
    <p>If you don’t agree with the new Terms, you are free to discontinue using the Services. Continued use of luxGold after updated Terms go into effect means you agree to them.</p>
    ...
    <ul>
      ...
      <li>To use luxGold only for lawful purposes, consistent with our mission to connect customers with trusted cleaners.</li>
    </ul>
    ...
    <p>All content on luxGold (logos, text, graphics, design, software) is owned by luxGold or its licensors. You may not use, copy, or distribute content without permission, except for personal, non-commercial use.</p>
    ...
    <h4>Termination</h4>
    <p>You may stop using luxGold at any time. We may suspend or terminate your account if you violate these Terms. Certain obligations (fees, intellectual property rights, indemnities, etc.) will survive termination.</p>
